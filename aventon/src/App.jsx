...
function App() {
  ...
  return (
    ...
    <div>
        ...
        <section className='bg-black hero dark:bg-white'>
        <p className='reveal-type split-type text-white text-center md:text-left dark:text-black text-[30px] md:text-6xl font-bold'> 
        Elevate <span className='gradient-text'>customer</span> satisfaction and engagement while benefiting from cost savings, personalized interactions, and exceptional support.</p> <div className='h-[30em] w-[30em] bg-blue-200'></div>
        </section>
