...
export default function process() {
  return (
    <div className='w-full mt-[15em] md:mt-0 relative md:w-[70%] xl:w-[40%] flex flex-col items-center justify-center '>
        <div className='absolute hero3'></div>
    ...
    <div className='flex flex-col md:flex-row gap-7 w-full justify-between'>
       ...
       <div className='h-[17em] md:w-[18em] border dark:border-none rounded-lg relative '>
           <div className='absolute  w-full h-full bg-white dark:bg-gray-500 opacity-20'></div>
