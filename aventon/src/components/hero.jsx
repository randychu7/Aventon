...
Aventon Automation drives business success through smart integration, automation enabling seamless efficiency and increased revenue generation.
                ...
                <div className='flex gap-12 justify-center md:justify-start mt-5'>
                <a href="#" className="text-gray-500 w-[50px] h-[50px] rounded-full flex items-center justify-center  hover:bg-gray-300 transition-all dark:text-white border duration-200 hover:text-gray-900 dark:hover:text-white">
              <svg
                className="w-[30px]"
                fill="currentColor"
                viewBox="0 0 24 24"
